...
This directory contains the cleaned and reproducible notebooks and scripts used
for capsule-based analysis and 1D MCMC modeling in the Mazelis et al. (2025) study.

The materials here support transparency and reproducibility of the analyses
...
- script1_Capsule_processing.ipynb
  Preprocessing and capsule-level analysis of single-cell data.

- script2_MCMC.ipynb
  Training and evaluation of a 1D MCMC surrogate model based on simulated data.
