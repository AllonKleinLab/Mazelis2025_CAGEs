...
class MCMCInference:
    ...
    def setup_model(self):
        ...
        with pm.Model() as self.model:
            ...
            threshold = pm.Uniform('threshold', lower=0, upper=2e-3, dtype="float64")
    ...
    def plot_predictions(self, figsize=(6, 6)):
        ...
        for i, t in enumerate(self.times):
            ...
            plt.hist(np.log10(est_params['threshold'] + x_t), 
        ...
        plt.errorbar(self.times, empirical_means, yerr=empirical_sems, fmt='go', label='Data', capsize=5)
