...
def process_ad(adata, normalize=True, min_counts=3, min_cells=3, min_vscore_pctl=85, plot_vscore=False, 
               n_components=30, n_neighbors=15, umap_min_dist=0.3, leiden_res=1.0, norm_frac = 0.1, sparse_pca=False, norm_sum = 1e4,
    ...
    if normalize:
        ...
        sc.pp.normalize_total(adata, target_sum = norm_sum, exclude_highly_expressed = True, max_fraction= norm_frac)
...
def plot_one_gene(E, gene_list, gene_to_plot, x, y, normalize=False, ax=None, order_points=True, col_range=(0,100), buffer_pct=0.03, point_size=20, color_map=None, smooth_operator=None):
...
def plot_gene_list(adata, genes_plot, embedding='X_umap', save_filename=None, close_after_save=False, dpi=100, n_columns=6, vmax=99.6, **plot_kwargs):
